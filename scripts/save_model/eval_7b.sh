...
CUDA_VISIBLE_DEVICES=0 python experiments/run_lm_eval.py \
        --model meta-llama/Llama-2-13b-hf \
        --sliced-model-path "/root/home/workspace/TransformerCompression/exp/summary/llama_v2_13b/0.30" \
        --save-dir "/root/home/workspace/TransformerCompression/exp/summary/llama_v2_13b/0.30" \
        --sparsity 0.30 \
        --batch-size 4 \
        --distribute-model \
        --no-wandb

CUDA_VISIBLE_DEVICES=1 python experiments/run_lm_eval.py \
        --model meta-llama/Llama-2-13b-hf \
        --sliced-model-path "/root/home/workspace/TransformerCompression/exp/summary/llama_v2_13b/0.40" \
        --save-dir "/root/home/workspace/TransformerCompression/exp/summary/llama_v2_13b/0.40" \
        --sparsity 0.40 \
        --batch-size 4 \
        --distribute-model \
        --no-wandb

CUDA_VISIBLE_DEVICES=2 python experiments/run_lm_eval.py \
        --model meta-llama/Llama-2-13b-hf \
        --sliced-model-path "/root/home/workspace/TransformerCompression/exp/summary/llama_v2_13b/0.50" \
        --save-dir "/root/home/workspace/TransformerCompression/exp/summary/llama_v2_13b/0.50" \
        --sparsity 0.50 \
        --batch-size 4 \
        --distribute-model \
        --no-wandb