...
from slicegpt.models.hf_baichuan.baichuan2_13B.modeling_baichuan import RMSNorm, BaichuanLayer, BaichuanForCausalLM
from slicegpt.models.hf_baichuan.baichuan2_13B.configuration_baichuan import BaichuanConfig

from slicegpt.model_adapter import LayerAdapter, ModelAdapter


class CompressedBaichuan2_13BDecoderLayer(BaichuanLayer):
    def forward(
            self,
...
class Baichuan2_13BLayerAdapter(LayerAdapter):
    def __init__(self, layer: BaichuanLayer) -> None:
        super().__init__()
        self._layer: BaichuanLayer = layer
...
class Baichuan2_13BModelAdapter(ModelAdapter):
    ...
    def layer_adapter_type(self) -> type:
        return Baichuan2_13BLayerAdapter

    @property
    def compressed_layer_type(self) -> type:
        return CompressedBaichuan2_13BDecoderLayer
    ...
    def _from_pretrained(
        ...
        *,
        ...
        if not model_name.startswith("baichuan-inc/Baichuan2-13B-Base"):        # "baichuan-inc/Baichuan2-13B-Base" can also be load actually by baichuan1-13b
            return None
        ...
        return Baichuan2_13BModelAdapter(model)
    ...
    def _from_uninitialized(
        ...
        *,
        ...
        if not model_name.startswith("baichuan-inc/Baichuan2-13B-Base"):     
            return None
